...
subtitle: <h1>An Application to Strathcona County, Alberta</h>
...
The map below shows the landscape importance score associated with each quarter-section located within Strathcona County, Alberta. The user can select specific quarter-sections and be given the legal land description and importance score, as well as display satellite imagery.  
...
pc_cwpt <- ab_cwpt_indices %>%
  filter(C_MD_SA == "Strathcona County")
